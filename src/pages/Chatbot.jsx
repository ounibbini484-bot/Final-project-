  ...
  const handleQuickReply = (question)=>{
    ...
    setTimeout(() => {
      ...
      if(question === "Where is my order?"){
        botResponse = "Your order #100064063 is currently out for delivery and should arrive within 20 minutes🛵";
      }
      ...
      {isOpen && (
        <div className="chatbot-window">
          ...
          <div className="chatbot-quick-replies">
            <button className="quick-reply-btn" onClick={() => handleQuickReply("Where is my order?")}>Where is my order?</button>
            
            <button className="quick-reply-btn" onClick={() => handleQuickReply("Cancel order")}>Cancel order</button>
            
            <button className="quick-reply-btn" onClick={() => handleQuickReply("Where is the restaurant?")}>Where is the restaurant?</button>
            <button className="quick-reply-btn" onClick={() => handleQuickReply("Talk to human")}>Talk to human</button>
