 ...
 <div className='Ceckout-card'>
  ...
  {!subminted ?(
    <form onSubmit={handleSubmit} className='checkout-from'>
      ...
      <input type='text' value={name} onChange={e => setName(e.target.value)} required placeholder='Mohmed Ali'/>
    </div>
    <div className='Checkout from '>
      <label> Address</label>
      <textarea value={address} onChange={e => setAddress(e.target.value)} required rows="3" placeholder='123 street'></textarea>
  ...
  <button type='submit' className='btn submit-btn'> Conferm order</button>
    ...
    <h2> Order placed </h2>
    <p> Thank you for your order<strong>{address}</strong></p>
